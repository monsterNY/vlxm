...
namespace Command.RedisHelper.Helper
{

    /// <summary>
    /// MSSQ study
    /// source code by site:https://www.cnblogs.com/cklovefan/p/7821862.html
    /// </summary>
    public class SiteRedisHelper
    {
        ...
        public object SubscribeAsync(RedisChannel redisChannel, Func<object, object, object> p)
        {
        ...
        //        /// </summary>
        //        /// <param name="db"></param>
        //        public SiteRedisHelper(int db = -1)
        //        {
...
//            }
        ...
        public T ListLeftPop<T>(string redisKey)
        {
            ...
            return string.IsNullOrWhiteSpace(redisValue)?default(T):JsonConvert.DeserializeObject<T>(redisValue);
        }
        /// <summary>
        /// 移除并返回该列表上的最后一个元素
        /// </summary>
