...
namespace Tools.CusTools
{
  ...
  public static class ApiHelper
  {
      ...
      Encoding encoding = null, int timeOut = 10000)
    {
      ...
      if (param != null)
        url += "?" + string.Join("&", param.Select(u => $"{u.Key}={u.Value}"));
    ...
    /// <param name="timeOut"></param>
    /// <returns></returns>
    public static string HttpPost(string url, Dictionary<string, string> formData = null, Encoding encoding = null,
      int timeOut = 10000)
    {
      HttpClientHandler handler = new HttpClientHandler();
    ...
    public async static Task<string> HttpPostJson(string url, Dictionary<string, string> formData = null,
      Encoding encoding = null, int timeOut = 10000)
    {
      HttpClientHandler handler = new HttpClientHandler();
